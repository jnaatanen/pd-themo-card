 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: mt, defineProperty: ft, getOwnPropertyDescriptor: bt, getOwnPropertyNames: xt, getOwnPropertySymbols: yt, getPrototypeOf: $t } = Object, C = globalThis, Le = C.trustedTypes, wt = Le ? Le.emptyScript : "", ve = C.reactiveElementPolyfillSupport, G = (t, e) => t, le = { toAttribute(t, e) {
  switch (e) {
    case Boolean:
      t = t ? wt : null;
      break;
  ...
  return i;
} }, Te = (t, e) => !mt(t, e), Fe = { attribute: !0, type: String, converter: le, reflect: !1, useDefault: !1, hasChanged: Te };
...
let j = class extends HTMLElement {
  ...
  _$AK(e, i) {
    ...
    if (s !== void 0 && this._$Em !== s) {
      const n = o.getPropertyOptions(s), d = typeof n.converter == "function" ? { fromAttribute: n.converter } : ((r = n.converter) == null ? void 0 : r.fromAttribute) !== void 0 ? n.converter : le;
      this._$Em = s;
      const p = d.fromAttribute(i, n.type);
  ...
  requestUpdate(e, i, o, s = !1, r) {
    ...
    if (e !== void 0) {
      ...
      if (s === !1 && (r = this[e]), o ?? (o = n.getPropertyOptions(e)), !((o.hasChanged ?? Te)(r, i) || o.useDefault && o.reflect && r === ((a = this._$Ej) == null ? void 0 : a.get(e)) && !this.hasAttribute(n._$Eu(e, o)))) return;
      this.C(e, i, o);
    }
...
j.elementStyles = [], j.shadowRootOptions = { mode: "open" }, j[G("elementProperties")] = /* @__PURE__ */ new Map(), j[G("finalized")] = /* @__PURE__ */ new Map(), ve == null || ve({ ReactiveElement: j }), (C.reactiveElementVersions ?? (C.reactiveElementVersions = [])).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const J = globalThis, Ve = (t) => t, de = J.trustedTypes, We = de ? de.createPolicy("lit-html", { createHTML: (t) => t }) : void 0, rt = "$lit$", A = `lit$${Math.random().toFixed(9).slice(2)}$`, at = "?" + A, _t = `<${at}>`, H = document, K = () => H.createComment(""), Q = (t) => t === null || typeof t != "object" && typeof t != "function", Ae = Array.isArray, zt = (t) => Ae(t) || typeof (t == null ? void 0 : t[Symbol.iterator]) == "function", me = `[ 	
\f\r]`, Z = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Ze = /-->/g, Ge = />/g, I = RegExp(`>|${me}(?:([^\\s"'>=/]+)(${me}*=${me}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Je = /'/g, Ke = /"/g, nt = /^(?:script|style|textarea|title)$/i, lt = (t) => (e, ...i) => ({ _$litType$: t, strings: e, values: i }), l = lt(1), y = lt(2), B = Symbol.for("lit-noChange"), m = Symbol.for("lit-nothing"), Qe = /* @__PURE__ */ new WeakMap(), M = H.createTreeWalker(H, 129);
function dt(t, e) {
...
const kt = (t, e) => {
  ...
  for (let n = 0; n < i; n++) {
    const d = t[n];
    let p, g, h = -1, v = 0;
    for (; v < d.length && (a.lastIndex = v, g = a.exec(d), g !== null); ) v = a.lastIndex, a === Z ? g[1] === "!--" ? a = Ze : g[1] !== void 0 ? a = Ge : g[2] !== void 0 ? (nt.test(g[2]) && (s = RegExp("</" + g[2], "g")), a = I) : g[3] !== void 0 && (a = I) : a === I ? g[0] === ">" ? (a = s ?? Z, h = -1) : g[1] === void 0 ? h = -2 : (h = a.lastIndex - g[2].length, p = g[1], a = g[3] === void 0 ? I : g[3] === '"' ? Ke : Je) : a === Ke || a === Je ? a = I : a === Ze || a === Ge ? a = Z : (a = I, s = void 0);
    const x = a === I && t[n + 1].startsWith("/>") ? " " : "";
    r += a === Z ? d + _t : h >= 0 ? (o.push(p), d.slice(0, h) + rt + d.slice(h) + A + x) : d + A + (h === -2 ? n : x);
  }
    ...
    for (; (s = M.nextNode()) !== null && d.length < n; ) {
      if (s.nodeType === 1) {
        ...
        if (nt.test(s.tagName)) {
          const h = s.textContent.split(A), v = h.length - 1;
          if (v > 0) {
            s.textContent = de ? de.emptyScript : "";
            for (let x = 0; x < v; x++) s.append(h[x], K()), M.nextNode(), d.push({ type: 2, index: ++r });
            s.append(h[v], K());
          }
        }
...
function L(t, e, i = t, o) {
  ...
  return (s == null ? void 0 : s.constructor) !== r && ((n = s == null ? void 0 : s._$AO) == null || n.call(s, !1), r === void 0 ? s = void 0 : (s = new r(t), s._$AT(t, i, o)), o !== void 0 ? (i._$Co ?? (i._$Co = []))[o] = s : i._$Cl = s), s !== void 0 && (e = L(t, s._$AS(t, e.values), s, o)), e;
}
class Tt {
  constructor(e, i) {
  ...
  u(e) {
    ...
    M.currentNode = s;
    let r = M.nextNode(), a = 0, n = 0, d = o[0];
    for (; d !== void 0; ) {
      if (a === d.index) {
        let p;
        d.type === 2 ? p = new se(r, r.nextSibling, this, e) : d.type === 1 ? p = new d.ctor(r, d.name, d.strings, this, e) : d.type === 6 && (p = new Ot(r, this, e)), this._$AV.push(p), d = o[++n];
      }
...
class se {
  ...
  constructor(e, i, o, s) {
    this.type = 2, this._$AH = m, this._$AN = void 0, this._$AA = e, this._$AB = i, this._$AM = o, this.options = s, this._$Cv = (s == null ? void 0 : s.isConnected) ?? !0;
  }
  get parentNode() {
  ...
  _$AI(e, i = this) {
    e = L(this, e, i), Q(e) ? e === m || e == null || e === "" ? (this._$AH !== m && this._$AR(), this._$AH = m) : e !== this._$AH && e !== B && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : zt(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== m && Q(this._$AH) ? this._$AA.nextSibling.data = e : this.T(H.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    var r;
...
class he {
  ...
  constructor(e, i, o, s, r) {
    this.type = 1, this._$AH = m, this._$AN = void 0, this.element = e, this.name = i, this._$AM = s, this.options = r, o.length > 2 || o[0] !== "" || o[1] !== "" ? (this._$AH = Array(o.length - 1).fill(new String()), this.strings = o) : this._$AH = m;
  }
  _$AI(e, i = this, o, s) {
    ...
    if (r === void 0) e = L(this, e, i, 0), a = !Q(e) || e !== this._$AH && e !== B, a && (this._$AH = e);
      ...
      const n = e;
      let d, p;
      for (e = r[0], d = 0; d < r.length - 1; d++) p = L(this, n[o + d], i, d), p === B && (p = this._$AH[d]), a || (a = !Q(p) || p !== this._$AH[d]), p === m ? e = m : e !== m && (e += (p ?? "") + r[d + 1]), this._$AH[d] = p;
    }
    a && !s && this.j(e);
  }
  j(e) {
...
class Et extends he {
  ...
  _$AI(e, i = this) {
    if ((e = L(this, e, i, 0) ?? m) === B) return;
    const o = this._$AH, s = e === m && o !== m || e.capture !== o.capture || e.once !== o.once || e.passive !== o.passive, r = e !== m && (o === m || s);
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Pt = { attribute: !0, type: String, converter: le, reflect: !1, hasChanged: Te }, It = (t = Pt, e, i) => {
...
function Ht(t, e) {
  ...
  if (!o) return null;
  const s = (n = t.devices) == null ? void 0 : n[o], r = (s == null ? void 0 : s.identifiers) ?? [];
  for (const d of r)
    if (d[0] === "pd_hathemo") {
...
function U(t, e, i, o, s = !1) {
  ...
  for (const n of Object.keys(r))
    if (((a = r[n]) == null ? void 0 : a.device_id) === e && n.startsWith(i + ".") && (s ? n.endsWith("_" + o) : n.includes(o)))
      return n;
  return null;
}
function Nt(t, e, i) {
  ...
  const o = t.states[e];
  if (!o) return null;
  const s = o.attributes, r = (u = (x = t.entities) == null ? void 0 : x[e]) == null ? void 0 : u.device_id, a = U(t, r, "sensor", "room_temperature"), n = U(t, r, "sensor", "floor_temperature"), d = U(t, r, "sensor", "outside_temperature"), p = U(t, r, "binary_sensor", "heating"), g = U(t, r, "light", "backlight"), h = U(t, r, "sensor", "heating_today", !0), v = (Ue) => Ue ? t.states[Ue] : void 0;
  return {
    climateEntityId: e,
    ...
    mode: qt[o.state] ?? "off",
    heating: (s.hvac_action ?? ((_ = v(p)) == null ? void 0 : _.state)) === "heating" || ((Me = v(p)) == null ? void 0 : Me.state) === "on",
    minTemp: k(s.min_temp) ?? 5,
    maxTemp: k(s.max_temp) ?? 35,
    step: k(s.target_temp_step) ?? i,
    roomTemp: k((De = v(a)) == null ? void 0 : De.state),
    floorTemp: k((He = v(n)) == null ? void 0 : He.state),
    outsideTemp: k((qe = v(d)) == null ? void 0 : qe.state),
    heatingTodayPct: k((Re = v(h)) == null ? void 0 : Re.state),
    backlightEntityId: g,
    backlightOn: g ? ((Ne = v(g)) == null ? void 0 : Ne.state) === "on" : null,
...
function ct(t, e) {
  const i = t.setpoints.filter((a) => a.day === e).sort((a, n) => a.hour - n.hour), o = new Array(24).fill(null);
...
ee.styles = [w, ue, b`:host{display:contents;}`];
Oe([
  c({ attribute: !1 })
], ee.prototype, "zone", 2);
Oe([
    ...
    return l`
      <section class="ha-card themo-overview">
        <div class="card-head">
          ...
          ${t ? l`<span class="pill heat"><span class="dot"></span>Heating now</span>` : ""}
          ${this.outsideText ? l`<span class="pill outside"><span class="dot"></span>Outside ${this.outsideText}</span>` : ""}
        </div>
        ...
        <div class="strip">
          ...
          ${this.sunText ? l`<div class="stat"><div class="label">Sunrise → Sunset</div><div class="val">${this.sunText}</div></div>` : ""}
        </div>
        ...
        ${this.quickActions.length ? l`
          <div class="quick-actions">
            <span class="qa-label">Quick actions</span>
            ${this.quickActions.map((e) => l`
    ...
    return l`
      <div class="schedule">
        <div class="schedule-head">
          ...
          <div class="next">${this.nextChange ? l`Next change <strong>${String(this.nextChange.hour).padStart(2, "0")}:00 → ${this.nextChange.value}°</strong>` : "No further changes today"}</div>
        </div>
        <div style="display:flex;gap:6px;flex-wrap:wrap;margin-bottom:12px">
          ${t.presetModes.map((s) => l`
...
E.styles = [w, ue, b`:host{display:block;}`];
F([
  c({ attribute: !1 })
], E.prototype, "zone", 2);
F([
...
let R = class extends f {
  ...
  render() {
    ...
    return l`
      <div class="head-card">
        <div class="row">
          ${this.activeCount > 0 ? l`<div class="badge"><span class="dot"></span>Heating now</div>` : l`<div></div>`}
          ${this.outsideText ? l`<div class="outside">Outside ${this.outsideText}</div>` : ""}
        </div>
        <div class="big-temp">
          <div class="now">${t !== null ? Xe(t) : "—"}<span class="unit">°</span></div>
          ${i !== null ? l`<div class="delta">${i >= 0 ? "+" : ""}${i.toFixed(1)}° vs target</div>` : ""}
        </div>
        ...
        <div class="breakdown">
          ...
          ${this.energyToday ? l`<div class="b"><div class="k">Today kWh</div><div class="v">${this.energyToday}</div></div>` : ""}
          ${this.energyCost ? l`<div class="b"><div class="k">Cost</div><div class="v">${this.energyCost}</div></div>` : ""}
        </div>
      </div>`;
  }
};
...
ce.styles = [w, ge, b`:host{display:block;}`];
pt([
  c({ attribute: !1 })
], ce.prototype, "zone", 2);
ce = pt([
...
let O = class extends f {
  ...
  render() {
    ...
    return l`
      ...
      <div class="zlist">
        ${this.zones.map((e) => l`<themo-zone-row .zone=${e}></themo-zone-row>`)}
      </div>
...
var li = Object.defineProperty, di = Object.getOwnPropertyDescriptor, Se = (t, e, i, o) => {
...
te.styles = [w, ge, b`:host{display:contents;}`];
Se([
  c({ attribute: !1 })
], te.prototype, "zone", 2);
Se([
      ...
      <div class="${i}" @click=${() => this.select()}>
        <div>
          ...
          <div class="big-temp">
            ...
            <div class="u">°C</div>
            ${e ? l`<div class="delta ${e.cool ? "cool" : ""}">${e.text}</div>` : ""}
          </div>
          <div class="target-line">→ <span class="target">${t.targetTemp !== null ? `${t.targetTemp}°` : "—"}</span>${t.targetTemp !== null ? " setpoint" : ""}</div>
          <div class="meta-line">${ht(t)}</div>
        </div>
      </div>`;
  }
};
ie.styles = [w, Pe, b`:host{display:block;min-height:0;} .ztile{height:100%;}`];
Ie([
  c({ attribute: !1 })
], ie.prototype, "zone", 2);
Ie([
...
var vi = Object.defineProperty, mi = Object.getOwnPropertyDescriptor, ut = (t, e, i, o) => {
  for (var s = o > 1 ? void 0 : o ? mi(e, i) : e, r = t.length - 1, a; r >= 0; r--)
    (a = t[r]) && (s = (o ? a(e, i, s) : a(s)) || s);
  return o && s && vi(e, i, s), s;
};
  ...
  render() {
    ...
    return l`
      <div class="focus-card">
        ...
        ${t.presetModes.length ? l`
          <div class="preset-row">
            ${t.presetModes.map((i) => l`
...
var bi = Object.defineProperty, xi = Object.getOwnPropertyDescriptor, P = (t, e, i, o) => {
  ...
  render() {
    ...
    return l`
      <div class="wrap">
        <div class="topbar">
          <div class="glance">
            ${this.outsideText ? l`<div class="gl"><div class="l">Outside</div><div class="v">${this.outsideText}</div></div>` : ""}
            <div class="gl"><div class="l">House avg</div><div class="v">${this.houseAvg ?? "—"}<span class="u">°C</span></div></div>
            ${this.energyToday ? l`<div class="gl"><div class="l">Today</div><div class="v">${this.energyToday}<span class="u">kWh</span></div></div>` : ""}
          </div>
          <div class="spacer"></div>
          ${this.heatingCount > 0 ? l`<div class="badge"><span class="dot"></span>Heating · ${this.heatingCount} of ${this.zones.length}</div>` : ""}
        </div>
        ...
        <div class="zones-foot">
          ...
          ${this.energyToday ? l`<div class="stat"><div class="v">${this.energyToday}<span class="u">kWh</span></div><div class="l">energy</div></div>` : ""}
          ${this.energyCost ? l`<div class="stat"><div class="v">${this.energyCost}</div><div class="l">cost</div></div>` : ""}
          ${this.energySpot ? l`<div class="stat"><div class="v">${this.energySpot}</div><div class="l">spot avg</div></div>` : ""}
        </div>

        <aside class="rail">
          ${t ? l`<themo-tablet-focus .zone=${t}></themo-tablet-focus>` : ""}
          ${this.quickActions.length ? l`
            <div class="qa-stack">
              <div class="qa-label">House actions</div>
              <div class="qa-row">
                ${this.quickActions.map((i) => l`
                  <button class="qa-btn" @click=${() => this.dispatchEvent(new CustomEvent("quick-action", { detail: { action: i }, bubbles: !0, composed: !0 }))}>
                    ...
                    ${i.description ? l`<div class="sub">${i.description}</div>` : ""}
                  </button>`)}
              </div>
            </div>` : ""}
        </aside>
...
let S = class extends f {
  ...
  energyGlance() {
    ...
    if (!t) return "";
    const e = this._hass.states[t];
    return e ? l`<themo-glance .value=${e.state} .unit=${e.attributes.unit_of_measurement ?? "kWh"} .sub=${"today · all zones"}></themo-glance>` : "";
  }
  energyValue(t) {
    var o;
    if (!t) return null;
  ...
  render() {
    var p, g, h, v, x;
    if (!this.config || !this._hass) return l``;
    const t = this.zones(), e = this.selected(t), i = (e == null ? void 0 : e.outsideTemp) ?? null, o = Ut(this.scheduleData), s = (/* @__PURE__ */ new Date()).getDay(), r = (/* @__PURE__ */ new Date()).getHours(), a = o ? ct(o, s) : null, n = o ? jt(o, s, r) : null, d = i !== null ? `${i}°C` : null;
    if (this.effectiveLayout() === "mobile") {
      const u = n ? `${String(n.hour).padStart(2, "0")}:00 → ${n.value}°` : null;
      return l`
        <themo-mobile-view
        ...
        ></themo-mobile-view>
        ${this.sheetOpen && e && (this.selectedId === null || e.climateEntityId === this.selectedId) ? l`<themo-mobile-sheet
    ...
    return this.effectiveLayout() === "tablet" ? l`
        <themo-tablet-view
          ...
          .energyCost=${this.energyValue((v = this.config.energy) == null ? void 0 : v.cost_entity)}
      ...
      <div class="view">
        ...
        <div class="right-col">
          ${e ? l`<themo-detail
            .zone=${e} .todayRow=${a} .nextChange=${n} .nowHour=${r} .step=${this.config.step}
            ...
            @backlight-toggle=${() => e.backlightEntityId && Ye(this._hass, e.backlightEntityId, e.backlightOn ?? !1)}
          ></themo-detail>` : l`<div>No Themo thermostats found.</div>`}
          ${this.energyGlance()}
        </div>
      </div>`;
  }
...
W([
  oe()
], S.prototype, "selectedId", 2);
W([
  oe()
], S.prototype, "scheduleData", 2);
W([
  oe()
], S.prototype, "band", 2);
W([
  oe()
], S.prototype, "sheetOpen", 2);
S = W([
  $("themo-card")
], S);
